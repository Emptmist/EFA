  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Video
          source={require('../../../assets/images/lunges.mp4')} // Correct path
          style={styles.gif}
          resizeMode="cover"
          isLooping
          isMuted
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/curtsylunges"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/curtsylunges"><Text style={styles.footerText}>Skip</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );

    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.gifContainer}>
          <Video
            source={require('../../../assets/images/cobra.mp4')} // Correct path
            style={styles.gif}
            resizeMode="cover"
            isLooping
            isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>COBRA STRETCH</Text>
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/strength"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/plank1"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>

...
export default function App() {
  const [timer, setTimer] = useState(30); // Set the initial countdown time in seconds
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Link href="/flexibility"><FontAwesome name="arrow-left" style={styles.backArrow} /></Link>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.gifContainer}>
          <Video
            source={require('../../../assets/images/kneetochestleft.mp4')} // Correct path
            style={styles.gif}
            resizeMode="cover"
            isLooping
            isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>KNEE-TO-CHEST STRETCH LEFT</Text>
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/spinelumbarright"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/kneetochestright"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>

        <TouchableOpacity style={styles.footerButton}>
          <FontAwesome name="caret-right" style={styles.footerIcon} />
          <Link href="/spinelumbarright"><Text style={styles.footerText}>Skip</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );

  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Link href="/balance"><FontAwesome name="arrow-left" style={styles.backArrow} /></Link>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.gifContainer}>
          <Video
            source={require('../../../assets/images/rightsquad.mp4')} // Correct path
            style={styles.gif}
            resizeMode="cover"
            isLooping
            isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>RIGHT QUAD STRETCH WITH WALL</Text>
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/backlunge"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/leftsquad"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>

        <TouchableOpacity style={styles.footerButton}>
          <FontAwesome name="caret-right" style={styles.footerIcon} />
          <Link href="/backlunge"><Text style={styles.footerText}>Skip</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );

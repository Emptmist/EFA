  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Video
          source={require('../../../assets/images/ABDOMINALCRUNCHES.mp4')} // Correct path
          style={styles.gif}
          resizeMode="cover"
          isLooping
          isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>ABDOMINAL CRUNCHES</Text>
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/vup"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/crossover"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>

        <TouchableOpacity style={styles.footerButton}>
          <FontAwesome name="caret-right" style={styles.footerIcon} />
          <Link href="/vup"><Text style={styles.footerText}>Skip</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );

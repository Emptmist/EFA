  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Video
          source={require('../../../assets/images/VUP.mp4')} // Correct path
          style={styles.gif}
          resizeMode="cover"
          isLooping
          isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>V-UP</Text>

        {/* Repetition Counter */}
        <Text style={styles.repetitionText}>x13</Text>

        {/* Done Button */}
        <TouchableOpacity style={styles.doneButton}>
          <FontAwesome name="check" style={styles.doneIcon} />
          <Link href="/legraises"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/abdominal"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>

        <TouchableOpacity style={styles.footerButton}>
          <FontAwesome name="caret-right" style={styles.footerIcon} />
          <Link href="/legraises"><Text style={styles.footerText}>Skip</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );

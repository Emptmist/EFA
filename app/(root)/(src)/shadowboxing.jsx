    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.gifContainer}>
          <Video
            source={require('../../../assets/images/shadowboxing.mp4')} // Correct path
            style={styles.gif}
            resizeMode="cover"
            isLooping
            isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>SHADOW BOXING</Text>
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/stepbacklunges"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/cardio"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>

        <TouchableOpacity style={styles.footerButton}>
          <FontAwesome name="caret-right" style={styles.footerIcon} />
          <Link href="/stepbacklunges"><Text style={styles.footerText}>Skip</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );

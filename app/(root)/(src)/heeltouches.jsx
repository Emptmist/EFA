  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Video
          source={require('../../../assets/images/HEELTOUCHES.mp4')} // Correct path
          style={styles.gif}
          resizeMode="cover"
          isLooping
          isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>HEEL TOUCHES</Text>

        {/* Repetition Counter */}
        <Text style={styles.repetitionText}>x30</Text>

        {/* Done Button */}
        <TouchableOpacity style={styles.doneButton}>
          <FontAwesome name="check" style={styles.doneIcon} />
          <Link href="/crossover"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/crossover"><Text style={styles.footerText}>Skip</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );

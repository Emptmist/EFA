    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.gifContainer}>
          <Video
            source={require('../../../assets/images/WALLCALFRAISES.mp4')} // Correct path
            style={styles.gif}
            resizeMode="cover"
            isLooping
            isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>WALL CALF RAISES</Text>
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/lowerbody"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/sidehops"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>

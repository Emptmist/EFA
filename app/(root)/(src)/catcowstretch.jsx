  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Link href="/corebody"><FontAwesome name="arrow-left" style={styles.backArrow} /></Link>
      </View>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/heeltouches"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/situps"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>

        <TouchableOpacity style={styles.footerButton}>
          <FontAwesome name="caret-right" style={styles.footerIcon} />
          <Link href="/heeltouches"><Text style={styles.footerText}>Skip</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );

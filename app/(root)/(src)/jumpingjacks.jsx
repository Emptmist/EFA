...
export default function App() {
  const [timer, setTimer] = useState(120); // Set the initial countdown time in seconds
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Link href="/strength"><FontAwesome name="arrow-left" style={styles.backArrow} /></Link>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.gifContainer}>
          <Video
            source={require('../../../assets/images/jumpingjacks.mp4')} // Correct path
            style={styles.gif}
            resizeMode="cover"
            isLooping
            isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>JUMPING JACKS</Text>
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/pushup1"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/strength"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>

        <TouchableOpacity style={styles.footerButton}>
          <FontAwesome name="caret-right" style={styles.footerIcon} />
          <Link href="/pushup1"><Text style={styles.footerText}>Skip</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );

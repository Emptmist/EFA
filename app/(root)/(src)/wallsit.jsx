...
export default function App() {
  const [timer, setTimer] = useState(40); // Set the initial countdown time in seconds
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.gifContainer}>
          <Video
            source={require('../../../assets/images/wallsit.mp4')} // Correct path
            style={styles.gif}
            resizeMode="cover"
            isLooping
            isMuted
        ...
        {/* Exercise Name */}
        <Text style={styles.exerciseText}>WALL SIT</Text>
        ...
        <TouchableOpacity style={styles.doneButton}>
          ...
          <Link href="/balance"><Text style={styles.doneText}>DONE</Text></Link>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton}>
          ...
          <Link href="/backlunge"><Text style={styles.footerText}>Previous</Text></Link>
        </TouchableOpacity>
